...
## Tasks
- [x] **1. Scaffold export.py: CLI, timestamp, paths**
...
- [x] **2. Implement .gitignore-aware file selection**
...
- [x] **3. Implement copy to snapshot folder**
...
- [x] **5. Logging, summary, and error handling**
...
- [x] **6. Usage docstring + manual-merge note**
