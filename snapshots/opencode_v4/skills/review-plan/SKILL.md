...
description: >-
  ...
  artifacts (spec.md, architecture.md, tasks.md) before code is written. Finds
  structural weaknesses, unnecessary complexity, and hidden assumptions. Load
  tier-calibration alongside this skill.
---
