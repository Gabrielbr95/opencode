...
1. **Architecture**: Strictly align with `architecture.md` and `spec.md`. Follow the folder structure exactly. Separate concerns into modules — no 500-line single files. Keep folder hierarchies **flat**; avoid unnecessary nesting or deep enterprise layer isolation.
